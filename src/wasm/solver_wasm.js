...
export class Solver {
     ...
     * @param {any} palette_strs
     */
    constructor(num_nodes, palette_strs) {
        const ret = wasm.solver_new(num_nodes, palette_strs);
     ...
     * @returns {any}
     */
    solve(start_id, max_depth) {
        const ret = wasm.solver_solve(this.__wbg_ptr, start_id, max_depth);
        return ret;
    }
    /**
     * @param {number} id
